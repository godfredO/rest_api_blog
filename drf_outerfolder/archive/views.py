...
class PostView(APIView):
    ...
    def get(self,request,*args,**kwargs):
        queryset = Post.objects.all()  #first read queryset from model
        serializer = PostSerializer(queryset,many=True)  #serialize the queryset
        #if serializer.is_valid():           #verify validity of serialized data
